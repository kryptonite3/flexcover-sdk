...
//    }
    ...
    private static String codegenFontList(List fonts)
	{
        ...
        for (Iterator it = fonts.iterator(); it.hasNext();)
        {
            ...
            fi.plain |= (!font.bold && !font.italic);
            fi.bolditalic |= (font.bold && font.italic);
            fi.bold |= font.bold;
							            ...
							            CompilerSwcContext swcContext)
    {
		...
		String[] codePieces = new String[]
	    {
	    	"package", lineSep,
	    	"{", lineSep, lineSep,
	    	codegenImports(base, rootAttributes, fonts, configuration),
	    	...
	    	"        super();", lineSep,
	    	codegenAddRslCompleteListener(configuration, lineSep),
	    	"    }", lineSep, lineSep,
	    	!isRsl ?
	    	"    override " : "",
	    	"    public function create(... params):Object", lineSep,
	    	"    {", lineSep,
	    	codegenCreateApply(isRsl, lineSep),
	...
	private static String codegenCreateApply(boolean isRsl, String lineSep)
	{
    	if (isRsl) 
    	{
    		return "";
										...
										Configuration configuration)
	{
		...
		String[] codePieces = new String[]
	    {
			codegenEventImport(configuration, lineSep),
	 ...
	 * @return
	 */
	private static String codegenEventImport(Configuration configuration, String lineSep)
	{
	 ...
	 * @param configuration
	 * @param lineSep
	 * @return ActionScript code to add an RSL complete listener. If the configuration is not
	 * 		   of type CompcConfiguration, no code is added.
	 */
	private static String codegenAddRslCompleteListener(Configuration configuration, String lineSep) {
	 ...
	 * @param configuration
	 * @param lineSep
	 * @return ActionScript code to add an RSL complete listener handler. If the configuration is not
	 * 		   of type CompcConfiguration, no code is added.
	 */
	private static String codegenRslCompleteListener(Configuration configuration, String lineSep)
	{
		if (!(configuration instanceof CompcConfiguration)) 
		{
			return "";
