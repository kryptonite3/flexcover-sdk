        ...
        implements TagValues
{
    ...
    {
        DefineFont t = new DefineFont(stagDefineFont2);
        return decodeDefineFont2And3(t);
    }

    private Tag decodeDefineFont3() throws IOException
    {
        DefineFont t = new DefineFont(stagDefineFont3);
        return decodeDefineFont2And3(t);
    }

    private Tag decodeDefineFont2And3(DefineFont t) throws IOException
    {
        int id = r.readUI16();
    ...
    private MorphFillStyle decodeMorphFillStyle(int shape) throws IOException
    {
        ...
        case 0x13:
            ...
            if (s.type == 0x13 && shape == stagDefineMorphShape2)
            {
            	s.ratio1 = r.readSI16();
            	s.ratio2 = r.readSI16();
            }
        ...
        case 0x40: // tiled
        case 0x41: // clipped
        case 0x42: // tiled, nonsmoothed
        case 0x43: // clipped, nonsmoothed
            int idref = r.readUI16();
            try
            {
...
//        f.highlightColor = decodeRGBA( r );
    ...
    {
        DefineFont t;
        t = new DefineFont(stagDefineFont);
        int id = r.readUI16();
    ...
    private FillStyle decodeFillStyle(int shape) throws IOException
    {
        ...
        case FillStyle.FILL_SOLID:
            ...
            break;
        case FillStyle.FILL_GRADIENT: // linear gradient fill
        case FillStyle.FILL_RADIAL_GRADIENT: // radial gradient fill
        case FillStyle.FILL_FOCAL_RADIAL_GRADIENT:
            s.matrix = decodeMatrix();
            s.gradient = decodeGradient(shape, s.type);
            break;
        case 0x40: // tiled bitmap fill
        case 0x41: // clipped bitmap fill
        case 0x42: // tiled non-smoothed fill
        case 0x43: // clipped non-smoothed fill
            int idref = r.readUI16();
            try
            {
                s.bitmap = dict.getTag(idref);
    ...
    {
        Gradient gradient = (filltype == 0x13)? new FocalGradient() : new Gradient();
        r.syncBits();
    ...
    public Tag decodeDefineFontAlignZones() throws IOException
    {
        ...
        zones.font = (DefineFont)dict.getTag(fontID);
