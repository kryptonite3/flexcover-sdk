/**
 *  	Class ExtDImplDDOverRideStaticErr
 *
 *  	This class overrides methods of the parent class
 *  	with  static methods in the sub class
 *
...
package Errors {
	...
	class ExtDImplDDOverRideStaticErr extends DynamicClass implements DefaultIntDef, DefaultInt {
	...
	var out = new ExtDImplDDOverRideStaticErr();
