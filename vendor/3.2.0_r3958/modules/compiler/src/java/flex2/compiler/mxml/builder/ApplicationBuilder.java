...
public class ApplicationBuilder extends ComponentBuilder
{
	...
	private void parseRootAttributes(Node node)
	{
		...
		// TODO: Create a constant for "Application" and "http://www.adobe.com/2006/mxml"
		boolean isApplication = "Application".equals(node.getLocalPart()) &&
								"http://www.adobe.com/2006/mxml".equals(node.getNamespace());
