/**
 *  	Class ExtDImplDDOverRidePubStaticErr
 *
 *  	This class overrides methods of the parent class
 *  	with public static methods in the sub class
 *
...
package Errors {
	...
	class ExtDImplDDOverRidePubStaticErr extends DynamicClass implements DefaultIntDef, DefaultInt {
	    ...
	    public static function getBoolean() : Boolean { return true; }
	    ...
	    public static function setPubBoolean( b:Boolean ) { return b; }
	    ...
	    public static function setPrivBoolean( b:Boolean ) { return b; }
	...
	var out = new ExtDImplDDOverRidePubStaticErr();
