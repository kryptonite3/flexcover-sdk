...
/**
 * A wrapper to make a DefineFont SWF Tag behave like a CachedFontFace
 * for use in the general Flex SDK FontManager subsystem. 
 */
public class DefineFontFace extends CachedFontFace
{
     ...
     * be null.
     */
    public DefineFontFace(DefineFont tag)
    {
    ...
    public static String getFamily(DefineFont tag)
    {
    ...
    public static int getStyle(DefineFont tag)
    {
        int style = 0;
        if (tag.bold)
            style += FontFace.BOLD;
    ...
    public static GlyphEntry createGlyphEntryFromDefineFont(char c, char index, DefineFont tag)
    {
