...
public interface TagValues
{
	...
	// Flash 8 tags
	int stagDefineShape4			= 67;	// includes enhanced line style and gradient properties
    ...
    int stagDoABC2                  = 82;   // revised ABC version with a name
    int stagDefineShape6            = 83;
	int stagDefineMorphShape2		= 84;	// includes enhanced line style abd gradient properties
    int stagDefineSceneAndFrameLabelData = 86;  // new in 8.5, only works on root timeline
	...
	int stagDefineBitsPtr			= 1023;  // a special tag used only in the editor
