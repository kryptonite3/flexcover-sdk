/**
 *  	Class ExtDImplDDAccPMFPubStatErr
 *
...
package Errors {
	...
	class ExtDImplDDAccPMFPubStatErr extends DynamicClass implements DefaultIntDef, DefaultInt {

	    public static function subGetArray() : Array { return getPubArray(); }
	    public static function subSetArray(a:Array) { setPubArray(a); }
	...
	var out = new ExtDImplDDAccPMFPubStatErr();


	out.subGetArray();
	out.iGetBoolean();

	// print( "FAILED, should give compile time error for accessing the default property from a public static method" );
}
