...
/**
 * An abstract implementation of most of the <code>Graphics2D</code> and <code>Graphics</code> APIs
 * to help render Java AWT to Macromedia Flash (SWF) format. Concrete extensions must implement
 * the {@link #draw(Shape)}, {@link #fill(Shape)} and {@link #drawString(String, float, float))
 * methods, as these typically need to be turned into physical SWF records.
 *
 * @author Pete
 * @version 0.9
 */
