...
public class I18nUtils
{
	...
	public static File getGeneratedResourceModule(CommandLineConfiguration configuration)
	{
		...
		// Get the locales that we're compiling resource bundles for.
		// These were specified by mxmlc's compiler.locale option.
		String[] locales = configuration.getCompilerConfiguration().getLocales();
		
		// Get the bundle names of the resource bundles
		// to be included in the resource module.
		// These were specified by mxmlc's include-resource-bundles option.
