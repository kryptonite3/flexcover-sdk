...
debug interface testInterface {
	function fun1();
	function fun2();
}


class Greeter implements testInterface {
    var greeting = "one"
    var greeting = "two"
//    public  function fun1() { print(greeting) }
//    public  function fun2() { print(greeting) }
    public  function fun1() { greeting }
    public  function fun2() { greeting }
}
