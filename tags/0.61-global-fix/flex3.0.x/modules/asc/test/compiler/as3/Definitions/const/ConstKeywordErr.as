...
const var myConst = 10;

AddTestCase( "The above statement should report an Error" );
AddTestCase( "Testing the 'const' and 'var' keywords: const var myConst = 10;", 10, myConst );
