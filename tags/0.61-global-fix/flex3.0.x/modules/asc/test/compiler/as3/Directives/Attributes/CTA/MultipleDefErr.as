...
var TITLE   = "Multiple CTA defined";       // Provide ECMA section title or a description
var BUGNUMBER = "";

startTest();          


/* Multiple debug defined in a line */
const debug debug1 debug2 name=true;
...
/* Multiple debug variable */
debug_m1 debug_m2 debug_m3 function assert1(x, y) {
