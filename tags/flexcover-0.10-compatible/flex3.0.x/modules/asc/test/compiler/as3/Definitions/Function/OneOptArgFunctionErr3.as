...
package Errors {
	...
	public class OneOptArgFunctionErr3{
		
		//Mentioning ... without rest
		function returnStringInner(...rest, s:String = "inside class inside package"):String { return s; }
		
		public function returnString():String { return returnStringInner(12); }
		
		
		//Mentioning ... without rest
		function returnBooleanInner(...rest, b:Boolean = true):Boolean { return b; }
		
		public function returnBoolean():Boolean { return returnBooleanInner("true"); }
		
		
		//Mentioning ... without rest
		function returnNumberInner(...rest, b:Number = 100):Number { return n; }
...
var TESTOBJ = new OneOptArgFunctionErr3();
