...
package Errors {
	...
	public class ThreeOptArgFunctionErr1{
		
	  function returnArgumentsInner(s:String = "Str1", b:Boolean = true, n:Number = 10) {
	  	str = s;
	  	bool = b;
	  	num = n;
	  }
	...
	function returnArgumentsInner(s:String = "Str2", b:Boolean = false, n:Number = 20) {
...
var TESTOBJ = new ThreeOptArgFunctionErr1();
