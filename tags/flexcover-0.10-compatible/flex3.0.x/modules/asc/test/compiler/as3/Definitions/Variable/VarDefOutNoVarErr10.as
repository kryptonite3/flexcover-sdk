...
package Errors {
	...
	// <empty> Identifier, Identifier:TypeExpressionA, Identifier:TypeExpressionB = AssignmentExpression
    	idIdAssign = false, idIdTypeExprAAssign:Array = new Array(1,2,3), idIdTypeExprBAssign:Boolean = true;
    	idIdAssignB, idIdTypeExprAAssignB:Array, idIdTypeExprBAssignB:Boolean = true;  
}
