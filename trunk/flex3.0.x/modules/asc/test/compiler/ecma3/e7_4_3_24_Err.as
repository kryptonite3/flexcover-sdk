...
/**
    ...
    abstract	final	    int	            short
    boolean	float	    interface       static
    byte	goto	    long	    synchronized
    char        implements  native          throws
    double      protected   package	    transient
...
function getTestCases() {
    ...
    var implements:Boolean = true;

    array[item++] = new TestCase( SECTION,  "var implements = true",     "error",    "var implements = true" );
    return ( array );
}
