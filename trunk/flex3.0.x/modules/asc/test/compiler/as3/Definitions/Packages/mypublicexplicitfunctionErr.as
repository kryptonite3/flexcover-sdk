 ...
 *                  * use shellASC.as
 */
package testexplicitFunction{
            
    public explicit function MyFunction():String{
        return "Hi!!! there";
    }
...
package testingexplicitFunction{
    import testexplicitFunction.*;
    public class myexplicitFunction{

         public function accMyString():String{
                                                    
             return testexplicitFunction.MyFunction();
...
import testexplicitFunction.*;
import testingexplicitFunction.*;
var SECTION = "Definitions";           // provide a document reference (ie, ECMA section)
var VERSION = "AS3";                   // Version of JavaScript or ECMA
var TITLE   = "Explicit Functions";  // Provide ECMA section title or a description
var BUGNUMBER = "";
...
var tstingexpcl= new myexplicitFunction();
tstingexpcl.accMyString();

         AddTestCase( "Testing an explicit function", "Hi!!! there",tstingexpcl.accMyString() );
