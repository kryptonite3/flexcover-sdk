...
package Errors {
	...
	class ExtDImplDDAccDMFStatErr extends DynamicClass implements DefaultIntDef, DefaultInt {

	    static function iBaseClass() : Array { return baseClass(); }


	}

	var out = new ExtDImplDDAccDMFStatErr();
