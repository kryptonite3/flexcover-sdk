...
package Errors {
	...
	public class ThreeOptArgFunctionErr4{
		
	  function returnArgumentsInner(n:Number = 10, ...rest:Number) {
	  	
	  }
		
	  public function returnArguments() { returnArgumentsInner(20,20,20,20); }
	}

	
	function returnArgumentsInner(b:Boolean = false, ...rest:String) {
	
		
	}
	
	
	public function returnArguments() { returnArgumentsInner(true,"10",10); }
	
}


function returnArgumentsNoPackage(s:String = "Str4", ...rest:String) {}
...
var TESTOBJ = new ThreeOptArgFunctionErr4();

TESTOBJ.returnArguments();

returnArguments();

returnArgumentsNoPackage("12",true,false);
