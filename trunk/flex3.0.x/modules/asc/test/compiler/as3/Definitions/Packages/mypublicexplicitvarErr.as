 ...
 *                  * use shellASC.as
 */
package testexplicitVar{
            
    public explicit var MyVar:String="Hi!!! there";
                 
}

package testingexplicitVar{
    import testexplicitVar.*;
    public class myexplicitVar{

        public function accMyString():String{
                                                    
             return testexplicitVar.MyVar;
...
import testexplicitVar.*;
import testingexplicitVar.*;
var SECTION = "Definitions";           // provide a document reference (ie, ECMA section)
var VERSION = "AS3";                   // Version of JavaScript or ECMA
var TITLE   = "Explicit Variables";  // Provide ECMA section title or a description
var BUGNUMBER = "";
...
var tstingexpcl= new myexplicitVar();
tstingexpcl.accMyString();
AddTestCase( "Testing an explicit class", "Hi!!! there",tstingexpcl.accMyString() );
