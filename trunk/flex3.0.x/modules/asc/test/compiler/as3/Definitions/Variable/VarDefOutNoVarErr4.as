...
package Errors {
	...
	// <empty> VariableBindingList, Identifier : TypeExpression = AssignmentExpression 
	id1TypeExprAssignExpr:Boolean = true, id2TypeExprAssignExpr:Boolean = false, id3TypeExprAssignExpr:Boolean = true;
	id1TypeExprAssignExprB:Boolean, id2TypeExprAssignExprB:Boolean, id3TypeExprAssignExprB:Boolean = true;
}
