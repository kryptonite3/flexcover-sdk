        ...
        implements TagValues
{
    ...
    private void encodeMorphFillstyles(MorphFillStyle[] fillStyles, SwfEncoder w, int code)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            case 0x13:
                ...
                if (style.type == 0x13 && code == stagDefineMorphShape2)
                {
            ...
            case 0x40: // tiled
            case 0x41: // clipped
            case 0x42: // tiled, not smoothed
            case 0x43: // clipped, not smoothed
                w.writeUI16(dict.getId(style.bitmap));
    ...
    private void encodeMorphLinestyles(MorphLineStyle[] lineStyles, SwfEncoder w, int code)
    {
        ...
        for (int i = 0; i < lineStyles.length; i++)
        {
            ...
            if (style.hasFill)
            {
            	encodeMorphFillstyles(new MorphFillStyle[] { style.fillType }, w, code);
            }
        }
    }
