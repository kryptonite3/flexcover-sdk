...
public class AtEmbed implements LineNumberMapped
{
    ...
    public static AtEmbed create(Object perCompileData, Source source, String value, String path, int line, String prefix)
    {
        AtEmbed result = null;
	 ...
	 */
	public static AtEmbed create(Object perCompileData, Source sourceFile, int beginLine, String value, boolean strType)
	{
